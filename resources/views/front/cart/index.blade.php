        ...
        <div class="cart-items">
            ...
            <div class="row">
                        ...
                        <tr>
                            ...
                            <td>
                                <form action="{{ route('cart.destroy', $item->rowId) }}" method="post">
                                    @csrf
                                    @method('delete')
                                     <button type="submit" class="btn btn-link  btn-sm">Remove</button><br>
                                </form>
                                <form action="{{ route('cart.saveLater', $item->rowId) }}" method="post">
                                    @csrf
                                    <button type="submit" class="btn btn-link  btn-sm">Save for later</button>
                                </form>
                ...
                <div class="col-md-12">
                    ...
                    @else
                    <a href="{{url('/user/login')}}" class="btn btn-outline-info">Please Login To Continue</a>
                    @endif
                    <hr>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <form action="{{ route('moveToCart', $item->rowId) }}" method="post">
                                    @csrf
                                    <button type="submit" class="btn btn-link  btn-sm">Move to cart</button>
                                </form>
